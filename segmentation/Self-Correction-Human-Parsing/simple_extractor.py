...
python3 simple_extractor.py --dataset 'lip' --model-restore 'checkpoints/lip.pth' --input-dir 'inputs' --output-dir 'outputs'
"""
...
# python simple_extractor.py --dataset lip --model-restore checkpoints/lip.pth --input-dir ~/try-on/data/zalando-hd-resized/train/train_tps --output-dir outputs
