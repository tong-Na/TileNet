...
class BaseOptions:
    ...
    def initialize(self, parser):
        ...
        parser.add_argument(
            ...
            type=str,
            default="basic",
            help="specify discriminator architecture [basic | n_layers | pixel | feature_match]. The basic model is a 70x70 PatchGAN. n_layers allows you to specify the layers in the discriminator",
        )
        parser.add_argument(
            "--netG",
            type=str,
            default="resnet_9blocks",
            help="specify generator architecture [resnet_9blocks | resnet_6blocks | unet_256 | unet_128 | refined | transunet | pix2pixhd]",
        )
        parser.add_argument(
        ...
        parser.add_argument(
            "--ways", action="store_true", help="specify get_transform ways"
        )
        parser.add_argument("--not_gan", action="store_true", help="if use gan model")
        parser.add_argument("--tilegan2", action="store_true", help="if use tilegan2")
